...
export default function HeroText() {
  return (
    <div className='w-full h-auto text-black flex flex-col gap-4 md:pl-16 justify-center lg:pt-16'>
        <h1 className='text-center text-3xl  sm:text-4xl xl:text-5xl mt-4 md:mt-16 md:text-left text-gradient'>Le-Na CLOUD</h1>

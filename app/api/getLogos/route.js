...
export async function GET(request) {
    const services = [
        ...
        { id:4, name:'Commarce cloud', Icon:'FaShoppingCart', color:'commarce', desc:'Çevrimiçi satın almadan her yerden teslim almaya kadar B2B ve B2C müşterileriyle bağlantı kurun.'},
